...
We evaluated traditional models (Ridge, Random Forest), gradient boosting methods (LightGBM, XGBoost, CatBoost), and a novel SE-ResNet neural network architecture combining entity embeddings, residual connections, and Squeeze-and-Excitation attention.

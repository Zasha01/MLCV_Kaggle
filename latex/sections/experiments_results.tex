...
Overall, the results indicate that the neural architecture benefits from its ability to learn nonlinear feature interactions and from its architectural design.

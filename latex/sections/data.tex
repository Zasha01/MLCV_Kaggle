...
\caption{Numerical input features.}
...
\centering
\renewcommand{\arraystretch}{1.1}
\caption{Categorical input features.}
...
Table~\ref{tab:num_features} and Table~\ref{tab:cat_features} summarize the numerical and categorical input variables.

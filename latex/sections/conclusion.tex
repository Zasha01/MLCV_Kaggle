...
\begin{enumerate}
    ...
    \item \textbf{Data augmentation is crucial}: Incorporating the original dataset during neural network training provided significant improvements.
...
\begin{itemize}
    \item Applying data augmentation to gradient boosting models for fair comparison

...
\textbf{1. Learned Feature Interactions:}
...
\textbf{4. Regularization Strategy:}
...
\begin{itemize}
    ...
    \item \textbf{Data requirements}: Neural networks are generally more data-hungry than GBMs, while gradient boosting methods tend to be more data-efficient on structured datasets.
\end{itemize}
